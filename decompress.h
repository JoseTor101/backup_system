...
/**
 * @brief Extrae un archivo específico de un ZIP a la ruta destino
 ...
 * @param archives Lista de todos los archivos ZIP abiertos para buscar fragmentos
 ...
 */
bool reconstructFragmentedFile(const std::string &outputPath, 
                             std::vector<std::pair<std::string, zip_t*>> &archives,
                             const std::string &fragmentBaseName,
                             int totalFragments,
