...
int main(int argc, char *argv[]) {
  ...
  // Usar la función unificada con o sin contraseña
  cout << "Comprimiendo"
       << (!encryptPassword.empty() ? " con encriptado..." : "...") << endl;
  bool success = compressFolderToSplitZip(sourceDir, outputZip, maxSizeMB,
                                          encryptPassword);
